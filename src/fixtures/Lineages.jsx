export const Lineages = {
    ...
    "Elf": {
        ...
        "Ability": "As an Elf, you have Advantage on checks to Recall Information. When taking a rest, you need only 4 hours, spending the time in a meditative state, in contrast to the standard 8 hours of resting and sleeping.",
    },
    "Human": {
        "Description": "Humans are a Jack-of-all-trades, pretty good at many things, but not particularly amazing at anything in particular.",
        "Ability": "As a human, you can add Half your Proficiency Bonus, rounded up, to any Ability Check that you do not already add your Proficiency Bonus to.",
    },
    "Orc": {
        "Description": "Orcs are the tall, brutish strong-type of the people in GORP.",
        "Ability": "As an Orc, you double your lifting/carrying/pushing capacity, you are considered Large to forced movement mechanics, and you can wield a two-handed melee with one hand (you cannot dual wield two-handed weapons).",
    },
    "Stout": {
        "Description": "The Stout consists of Gnomes, Dwarves, Halflings, etc. that share the following characteristics.",
        "Ability": "As a stout, you have resistance to being Poisoned and Poison damage. Additionally, you have Advantage on Ability Checks to hide behind cover.",
    },
}